...
public class TiendaFragment extends Fragment {
    ...
    private static final String ARG_NOMBRE_TIENDA = "nombre_tienda";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nombreTienda = (TextView) view.findViewById(R.id.nombre_tienda_detalle);
        valoracionTienda = (TextView) view.findViewById((R.id.valoracion_tienda_detalle));
